...
CREATE TABLE `__new_tasks` (
	...
	CONSTRAINT "tasks_task_type_check" CHECK("__new_tasks"."task_type" IN ('verify_claim', 'find_better_source', 'update_outdated_card', 'check_current_version', 'custom', 'weekly_review'))
);
