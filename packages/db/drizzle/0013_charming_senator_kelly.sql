...
CREATE TABLE `__new_assets` (
	...
	CONSTRAINT "assets_kind_check" CHECK("__new_assets"."kind" IN ('source_html', 'source_pdf', 'source_epub', 'import_archive', 'snapshot', 'image', 'audio', 'video', 'export', 'backup')),
...
ALTER TABLE `cards` ADD `source_uri` text;